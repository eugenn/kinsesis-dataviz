...
import com.amazonaws.services.kinesis.samples.datavis.servlet.GetImpressionCountsServlet;
 ...
 */
public class ImpressionWebServer {
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.addServlet(new ServletHolder(new GetImpressionCountsServlet(dynamoDBUtils.createMapperForTable(countsTableName))),
                "/GetCounts/*");
