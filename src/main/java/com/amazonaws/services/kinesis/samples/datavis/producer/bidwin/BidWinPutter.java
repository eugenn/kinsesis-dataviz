 ...
 */
public class BidWinPutter implements Putter {
    private static final Log LOG = LogFactory.getLog(BidWinPutter.class);
    ...
    public BidWinPutter(BidWinFactory bidWinFactory, AmazonKinesis kinesis, String streamName) {
