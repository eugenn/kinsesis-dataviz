...
public class BidReqWebServer {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 4) {
            System.err.println("Usage: " + BidReqWebServer.class
        ...
        context.addServlet(new ServletHolder(new GetBidRqCountsServlet(dynamoDBUtils.createMapperForTable(countsTableName))),
                "/GetCounts/*");
