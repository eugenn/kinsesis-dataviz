 ...
 */
public class ClicksPutter implements Putter {
    private static final Log LOG = LogFactory.getLog(ClicksPutter.class);

    private ClicksFactory bidWinFactory;
    private AmazonKinesis kinesis;
    private String streamName;

    private final ObjectMapper JSON = new ObjectMapper();

    public ClicksPutter(ClicksFactory bidWinFactory, AmazonKinesis kinesis, String streamName) {
     ...
     */
    private void sendRq() {
        ClicksRec winRec = bidWinFactory.create();
        byte[] bytes;
        try {
