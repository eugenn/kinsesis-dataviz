 ...
 */
public class BidRequestPutter implements Putter {
    private static final Log LOG = LogFactory.getLog(BidRequestPutter.class);

    private BidRequestFactory bidRequestFactory;
    private AmazonKinesis kinesis;
    private String streamName;

    private final ObjectMapper JSON = new ObjectMapper();

    public BidRequestPutter(BidRequestFactory bidRequestFactory, AmazonKinesis kinesis, String streamName) {
        if (bidRequestFactory == null) {
