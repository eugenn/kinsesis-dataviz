...
//
//    private CountPersister<BidRequestRec> persister;
//    private IRecordProcessorCheckpointer checkpointer;
//    private CountingRecordProcessor<BidRequestRec> processor;
...
//        processor = new CountingRecordProcessor<>(config, BidRequestRec.class, persister, 1000, 100);
...
//        new CountingRecordProcessor<>(null, BidRequestRec.class, persister, 100, 10);
//    }
//
//    @Test(expected = NullPointerException.class)
...
//        new CountingRecordProcessor<>(config, BidRequestRec.class, null, 100, 10);
//    }
//
//    @Test(expected = IllegalArgumentException.class)
//    public void GIVEN_processor_WHEN_rangeIsZero_THEN_throwException() {
//        new CountingRecordProcessor<>(config, BidRequestRec.class, persister, 0, 10);
//    }
//
//    @Test(expected = IllegalArgumentException.class)
//    public void GIVEN_processor_WHEN_intervalIsZero_THEN_throwException() {
//        new CountingRecordProcessor<>(config, BidRequestRec.class, persister, 10, 0);
//    }
//
//    @Test(expected = IllegalArgumentException.class)
//    public void GIVEN_processor_WHEN_rangeIsNotEvenlyDivisibleByIntervalLength_THEN_throwException() {
//        new CountingRecordProcessor<>(config, BidRequestRec.class, persister, 100, 80);
//    }
//
//    @Test(timeout = 3000)
...
//        record.setPartitionKey(pair.getWh());
...
//        BidRequestRec pair = new BidRequestRec();
//        pair.setWh("a");
//        pair.setType("b");
//
